...
# Импортируем из основного файла (bot.py)
# bot, dp, ADMIN_ID, get_db_connection уже доступны

# ============================================
# 1. СОЗДАНИЕ ТАБЛИЦЫ ОБРАТНОЙ СВЯЗИ
# ============================================
...
# ============================================
# 2. ПОЛУЧЕНИЕ ПОЛЬЗОВАТЕЛЕЙ С ИСТЕКШЕЙ ПОДПИСКОЙ
# ============================================
...
# ============================================
# 3. КЛАВИАТУРА С ВАРИАНТАМИ ОТВЕТОВ
# ============================================
...
# ============================================
# 7. НАЗВАНИЯ ТИПОВ ОБРАТНОЙ СВЯЗИ
# ============================================
...
async def cmd_feedback_stats(message: types.Message):
    ...
    try:
        ...
        for stat in stats:
            ...
            # Создаём визуальную полоску
            bar_length = int(percent / 5)  # 20 символов = 100%
    ...
    try:
        ...
        await message.answer_document(
            types.BufferedInputFile(
                output.getvalue().encode('utf-8-sig'),  # utf-8-sig для корректного отображения в Excel
