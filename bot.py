                    ...
                    if 68 <= hours_since_registration < 76:
                        if not get_funnel_message_sent(user_id, 'day3'):
                            ...
                            success = await send_safe_funnel_message(
                                ...
                                "• 1 месяц - всего 199₽ (вместо 499₽)\n"
                                "• Навсегда - 599₽ (одним платежом)\n\n"
                                "💡 Совет: большинство выбирают тариф Навсегда - "
                ...
                if 46 <= hours_since_expired < 50:
                    if not get_funnel_message_sent(user_id, 'expired_day2'):
                        ...
                        success = await send_safe_funnel_message(
                            ...
                            "💰 Всего 6₽ в день = тариф на 1 месяц\n"
...
async def faq_answer_1(callback: types.CallbackQuery):
    ...
    await callback.message.edit_text(
        ...
        "⚠️ **Важно:** Работает автоматическое продление. Вам не нужно будет продлевать подписку вручную каждый период.\n\n",
        reply_markup=keyboard,
        parse_mode="Markdown"
    )
            ...
            for user in users:
                ...
                try:
                    ...
                    await bot.send_message(
                        ...
                        "📚 <b>1000+ развивающих материалов</b> для детей\n"
